...
Level { # population
  ...
  Level { # individual
    Distrib(lnCltot, Normal, 0, 1); #not informative and wide because there are no indiv levels in literature
...
# individual experimental data, truncated to the latest change in concentration or amount excreted
# print is time collection for each sample of each individual, prints can be different for different matrices
